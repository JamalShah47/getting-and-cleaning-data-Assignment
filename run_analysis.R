unzip(zipfile = "D:/Rprogramming/getting and cleaning data/Assignment/dataset.zip",
      exdir = "D:/Rprogramming/getting and cleaning data/Assignment")
list.files("D:/Rprogramming/getting and cleaning data/Assignment")

pathdata = file.path("D:/Rprogramming/getting and cleaning data/Assignment", "UCI HAR Dataset")
